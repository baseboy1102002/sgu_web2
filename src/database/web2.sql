...
INSERT INTO `san_pham` (`id`, `ten_sp`, `descirption`, `img_path`, `in_stock`, `id_danh_muc`) VALUES
(1, 'Acer Nitro 5 Eagle', 'blah blah blah', 'path/path/path', 1, 1),
(2, 'Dell Inspiron 5515', 'blah blah blah', 'path/path/path', 1, 2),
(3, 'MSI Bravo', 'blah blah blah', 'path/path', 1, 6),
(4, 'HP Victus 16', 'blah blah blah', 'path/path', 1, 3),
(5, 'HP Omen', 'blah blah blah', 'path/path', 1, 3),
(6, 'Levono Legion 5', 'blah blah blah', 'path/path', 1, 4);
...
INSERT INTO `skus` (`id`, `sku_name`, `don_gia`, `so_luong`, `id_sp`, `in_stock`) VALUES
(1, 'AN-515 57-53F9 (i5/8G/256GB/RTX3050)', 20990000, 50, 1, 0),
(2, 'AN515 45 R6EV (r5/8G/512GB/GTX1650)', 18990000, 40, 1, 0),
(3, '8529 BLK (i5/4G/256GB)', 11490000, 60, 2, 0),
(4, '5174 BLK (i5/8G/512GB)', 19490000, 35, 2, 0),
(5, 'BD5VN r5/8G/512GB/GTX1650', 15990000, 25, 3, 1),
(6, 'BD5VN r5/8G/512GB/RTX3050', 17990000, 12, 3, 1),
(7, 'VTE54 r5/8G/512G/GTX1650', 16990000, 30, 4, 1),
(8, 'VTE54 r5/16G/512G/RTX3050', 20450000, 22, 4, 1),
(9, 'OME012 r7/16G/512G/RTX3060', 27950000, 8, 5, 1),
(10, 'LVLEG i5/8G/512G/RTX3060', 26450000, 14, 6, 1);
