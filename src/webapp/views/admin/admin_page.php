        ...
        <div class="row content">
            <div class="sidebar_menu col-sm-3 sidenav">
                <div class="list-group sidebar_menu-list">
                    <li class="sidebar_menu-items category list-group-item">
                        <i class="fa-solid fa-list"></i> Danh mục
                    </li>
                    <li class="sidebar_menu-items product menu_active list-group-item active">
                        <i class="fa-solid fa-box-open"></i> Sản phẩm
                    </li>
                    <li class="sidebar_menu-items ordernote list-group-item">
                        <i class="fa-solid fa-clipboard"></i> Đơn hàng
                    </li>
                    <li class="sidebar_menu-items account list-group-item">
                        <i class="fa-solid fa-users"></i> Tài khoản
                    </li>
                    <li class="sidebar_menu-items report list-group-item">
                        <i class="fa-solid fa-chart-pie"></i> Thống kê
                    </li>
                    <li class="sidebar_menu-items attribute list-group-item">
                        <i class="fas fa-tag"></i> Thuộc tính
                    </li>
                    <li class="sidebar_menu-items variant list-group-item">
                        <i class="fas fa-transgender-alt"></i> Biến thể
                    </li>
